...
def lambda_handler(event, context):
    ...
    try:
        ...
        for rule in non_compliant_rules:
            ...
            if '-conformance-pack-' in rule_name:
                ...
                if mapping_key not in rule_suffix_to_pack:
                    ...
                    elif 'encryption' in rule_name or 'kms' in rule_name or 'api-gw' in rule_name:
        ...
        def get_rule_details(rule):
            ...
            try:
                details_response = local_config_client.get_aggregate_compliance_details_by_config_rule(
                    ...
                    MaxResults=10  # Limit results per rule for performance
                )
                
                # Get conformance pack mapping
                rule_name = rule['ConfigRuleName']
                account_id = rule['AccountId']
                rule_suffix = None
        ...
        # Process rules in parallel with limited concurrency to avoid throttling
