    ...
    try:
        ...
        for rule in non_compliant_rules[:50]:  # Limit to first 50 for performance
            try:
                ...
                print(f"Could not get details for rule {rule['ConfigRuleName']}: {e}")
